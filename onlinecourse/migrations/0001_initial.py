# Generated by Django 3.1.3 on 2023-02-27 02:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_correct', models.CharField(choices=[(True, 'Correct'), (False, 'Incorrect')], default=False, max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choicies', models.ManyToManyField(to='onlinecourse.Choice')),
